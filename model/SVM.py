...
class ElectraForMultipleChoiceSVM(ElectraPreTrainedModel):
    ...
    def re_forward(
        ...
        outputs = (reshaped_logits,) + (pooled_output,) + outputs[1:]  # add hidden states and attention if they are here
